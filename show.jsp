...
<s:form method="post" theme="simple" action="%{progAction}">
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="0">
		...
		<tr class="trBgEven">
			...
			<td width="20%" class="colNameAlign required">&nbsp;<s:text name="exam.00002" />：</td>
			<td width="30%">
				<s:property value="labMemberMst.labMembRentHisCount" />
			</td>
		</tr>
		<tr class="trBgOdd">
    ...
    <table id="tblGrid" width="100%" border="0" cellpadding="2" cellspacing="1">
		...
		<s:iterator value="labMemberMst.labMembRentHisList" status="status">
            <tr>
	            ...
	            <td>
		            <label>
                		<s:property value="labMemberMst.labMembRentHisList[#status.index].labFilmMst.filmGrade"/>
               			<s:property value="labMemberMst.labMembRentHisList[#status.index].labFilmMst.filmgrade.optCdeNam"/>
               		</label>
	            </td>
            </tr>
        </s:iterator>
